...
async function renderRestaurants() {
    ...
    const container = document.getElementById('restaurant-container'); // Ensure this ID matches HTML structure
...
function createRestaurantCard(restaurant) {
    ...
    card.id = `restaurant-${restaurant.id}`; // Set the ID for the card
    card.setAttribute('data-id', restaurant.id); // Associate the card with the restaurant ID
